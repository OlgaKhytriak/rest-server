...
public class Constants {
    ...
    public static final String NEWS_WAS_ADDED = "News is added successfully";
    public static final String NEWS_WAS_UPDATED = "News is updated successfully";
    public static final String NEWS_WAS_DELETED = "News is deleted successfully";
